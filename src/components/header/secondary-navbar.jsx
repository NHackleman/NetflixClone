...
export default function secondaryNavbar() {
	return (
		<div className="secondary-navbar-wrapper">
			<div className="secondary-navbar-link">
				<div id="secondary-navbar-search-bar">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
			...
			<div className="secondary-navbar-link">
				<div id="secondary-navbar-kids-profile-icon">
					<Kids />
				</div>
			</div>
			<div className="secondary-navbar-link">
				<div id="secondary-navbar-notifications-button">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
			...
			<div className="secondary-navbar-link">
				<div className="secondary-navbar-profile-wrapper">
					<img
						className="secondary-navbar-profile-picture"
						src="./src/assets/user.png"
						alt="Profile-Picture"
					/>
					<img
						className="secondary-navbar-dropdown-arrow"
						src="./src/assets/drop-down-arrow.png"
						alt="Drop-Down-Arrow"
					/>
				</div>
			</div>
